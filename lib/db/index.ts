...
function seedDatabase(db: InstanceType<typeof Database>) {
  ...
  const seedTiles = [
    ...
    },
    {
      ...
      is_hidden: 0,
      is_active: 1,
      content: "{\"mark\":\"Work In progress\",\"role\":\"Software Engineer\",\"description\":\"Systems Architect. Specialized in high-performance web applications and immersive interfaces. Dark minimalist, cinematic UX.\"}",
