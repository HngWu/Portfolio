...
export { isSupabaseConfigured, testSupabaseConnection, resetSupabaseClient }
export {
...
function seedDatabase(db: InstanceType<typeof Database>) {
  ...
  const seedTiles = [
    ...
    },
    {
      ...
      is_hidden: 0,
      is_active: 1,
      content: "{\"mark\":\"Always Iterating · Always Improving\",\"role\":\"Software Engineer\",\"description\":\"Continuously refining this portfolio with modular architecture, clean system boundaries, and cinematic design in mind.\"}",
      deep_dive: "{\"mark\":\"Always Iterating · Always Improving\",\"role\":\"Software Engineer\",\"description\":\"Continuously refining this portfolio with modular architecture, clean system boundaries, and cinematic design in mind.\"}",
      created_at: "2026-08-15T04:15:26.773Z",
      updated_at: "2026-09-03T09:52:50.733Z"
    },
    {
    ...
    },
    {
      ...
      is_hidden: 0,
      is_active: 1,
      content: "{\"date\":\"Apr 2025 - Mar 2026\",\"role\":\"Software Engineer Intern\",\"company\":\"DBS Bank\",\"highlights\":[\"Led full-stack system migrations and automated pipeline deployments\",\"Optimized data processing to speed up heavy application modules\",\"Headed front-end overhauls and A/B testing to increase click-through rates\",\"Managed database version control for seamless multi-environment deployments\"],\"items\":[{\"id\":\"dbs-bank\",\"role\":\"Software Engineer Intern\",\"company\":\"DBS Bank\",\"date\":\"Apr 2025 - Mar 2026\",\"category\":\"Enterprise & Fintech\",\"highlights\":[\"Led full-stack system migrations and automated pipeline deployments\",\"Optimized data processing to speed up heavy application modules\",\"Headed front-end overhauls and A/B testing to increase click-through rates\",\"Managed database version control for seamless multi-environment deployments\"],\"deepDiveHighlights\":[\"Migrated Martech Request Portal from MongoDB to MariaDB using Java Spring Boot APIs\",\"Automated CI/CD deployment pipelines using Jenkins on OpenShift\",\"Optimized high-data spreadsheet module performance using efficient data structures\",\"Executed front-end A/B testing and tracking via Adobe Target and Adobe Analytics\",\"Managed MariaDB schema changes and version control utilizing Liquibase scripts\"]},{\"id\":\"ttp-support\",\"role\":\"Junior IT Application Support Engineer\",\"company\":\"To The Point Pte Ltd (TTP)\",\"date\":\"Sep 2024 - Present\",\"category\":\"IT Systems Support\",\"highlights\":[\"Executed end-to-end UAT and SIT testing cycles to validate software releases\",\"Investigated and debugged application issues and system anomalies across logs\",\"Authored comprehensive technical documentation, SOP runbooks, and test cases\",\"Coordinated deployment readiness and SLA defect tracking for client teams\"],\"deepDiveHighlights\":[\"Executed User Acceptance Testing (UAT) and System Integration Testing (SIT) for enterprise clients\",\"Identified edge-case regressions, debugged root causes in application logs, and logged structured defect reports\",\"Produced standardized operational runbooks, user manuals, and technical testing documentation\",\"Maintained incident response tracking and SLA adherence across production support workflows\"]}]}",
      ...
      created_at: "2026-08-15T04:15:26.773Z",
      updated_at: "2026-09-06T16:31:09.901Z"
    },
    {
    ...
    },
    {
      ...
      is_hidden: 0,
      is_active: 1,
      content: "{\"name\":\"TriviaDuel\",\"description\":\"Real-time multiplayer trivia platform with resilient AI generation.\",\"tech_stack\":[\"Next.js 16\",\"Gemini AI\",\"Redis\",\"SQLite\"],\"github_url\":\"https://github.com/HngWu\",\"live_url\":\"https://triviaduel.dev\",\"featured\":true,\"items\":[{\"id\":\"trivia-duel\",\"name\":\"TriviaDuel\",\"description\":\"Real-time multiplayer trivia platform with resilient AI generation.\",\"techStack\":[\"Next.js 16\",\"Gemini AI\",\"Redis\",\"SQLite\"],\"category\":\"Web Application\",\"year\":\"2025\",\"githubUrl\":\"https://github.com/HngWu\",\"liveUrl\":\"https://triviaduel.dev\",\"featured\":true,\"notes\":\"Sub-100ms synchronization for 10 players. Multi-model fallback strategy (Gemini → DeepSeek). Features Synapse V2 interactive canvas and AI-powered match roasts.\"},{\"id\":\"secure-asset\",\"name\":\"SecureAsset\",\"description\":\"Forensic watermarking & asset protection with LiquidGlass UI.\",\"techStack\":[\"React 19\",\"Node.js\",\"MariaDB\",\"Vite\"],\"category\":\"Cybersecurity\",\"year\":\"2025\",\"githubUrl\":\"https://github.com/HngWu\",\"liveUrl\":\"https://secureasset.dev\",\"featured\":true,\"notes\":\"Supports LSB, DCT, and EXIF embedding layers. Features deep-scan integrity authentication and verifiable digital signatures. Architected as an npm monorepo.\"},{\"id\":\"lumeglass-portfolio\",\"name\":\"LumeGlass Portfolio\",\"description\":\"Cinematic, dark minimalist portfolio showing modern animations and 3D visual elements.\",\"techStack\":[\"Next.js 16\",\"Tailwind CSS v4\",\"React Three Fiber\",\"GSAP\"],\"category\":\"Creative Engineering\",\"year\":\"2026\",\"githubUrl\":\"https://github.com/HngWu/Portfolio\",\"liveUrl\":\"https://portfolio.dev\",\"featured\":false,\"notes\":\"Implements custom GSAP timelines for bento grid navigation and R3F interactive canvas layers.\"},{\"id\":\"arcturus-engine\",\"name\":\"Arcturus Engine\",\"description\":\"WebGL-based real-time voxel graphics engine featuring volumetric lightning.\",\"techStack\":[\"Three.js\",\"GLSL Shaders\",\"TypeScript\",\"Vite\"],\"category\":\"Graphics Engine\",\"year\":\"2025\",\"githubUrl\":\"https://github.com/HngWu\",\"liveUrl\":\"https://arcturus.dev\",\"featured\":true,\"notes\":\"Volumetric rays are rendered using a custom screen-space post-processing shader. Multi-threaded octave chunking maps geometry in parallel.\"}]}",
      deep_dive: "{\"notes\":\"Sub-100ms synchronization for 10 players. Multi-model fallback strategy (Gemini → DeepSeek). Features Synapse V2 interactive canvas and AI-powered match roasts.\",\"items\":[{\"id\":\"trivia-duel\",\"name\":\"TriviaDuel\",\"description\":\"Real-time multiplayer trivia platform with resilient AI generation.\",\"techStack\":[\"Next.js 16\",\"Gemini AI\",\"Redis\",\"SQLite\"],\"category\":\"Web Application\",\"year\":\"2025\",\"githubUrl\":\"https://github.com/HngWu\",\"liveUrl\":\"https://triviaduel.dev\",\"featured\":true,\"notes\":\"Sub-100ms synchronization for 10 players. Multi-model fallback strategy (Gemini → DeepSeek). Features Synapse V2 interactive canvas and AI-powered match roasts.\"},{\"id\":\"secure-asset\",\"name\":\"SecureAsset\",\"description\":\"Forensic watermarking & asset protection with LiquidGlass UI.\",\"techStack\":[\"React 19\",\"Node.js\",\"MariaDB\",\"Vite\"],\"category\":\"Cybersecurity\",\"year\":\"2025\",\"githubUrl\":\"https://github.com/HngWu\",\"liveUrl\":\"https://secureasset.dev\",\"featured\":true,\"notes\":\"Supports LSB, DCT, and EXIF embedding layers. Features deep-scan integrity authentication and verifiable digital signatures. Architected as an npm monorepo.\"},{\"id\":\"lumeglass-portfolio\",\"name\":\"LumeGlass Portfolio\",\"description\":\"Cinematic, dark minimalist portfolio showing modern animations and 3D visual elements.\",\"techStack\":[\"Next.js 16\",\"Tailwind CSS v4\",\"React Three Fiber\",\"GSAP\"],\"category\":\"Creative Engineering\",\"year\":\"2026\",\"githubUrl\":\"https://github.com/HngWu/Portfolio\",\"liveUrl\":\"https://portfolio.dev\",\"featured\":false,\"notes\":\"Implements custom GSAP timelines for bento grid navigation and R3F interactive canvas layers.\"},{\"id\":\"arcturus-engine\",\"name\":\"Arcturus Engine\",\"description\":\"WebGL-based real-time voxel graphics engine featuring volumetric lightning.\",\"techStack\":[\"Three.js\",\"GLSL Shaders\",\"TypeScript\",\"Vite\"],\"category\":\"Graphics Engine\",\"year\":\"2025\",\"githubUrl\":\"https://github.com/HngWu\",\"liveUrl\":\"https://arcturus.dev\",\"featured\":true,\"notes\":\"Volumetric rays are rendered using a custom screen-space post-processing shader. Multi-threaded octave chunking maps geometry in parallel.\"}]}",
      created_at: "2026-08-15T04:15:26.773Z",
      updated_at: "2026-08-15T04:15:26.773Z"
    },
    {
    ...
    },
    {
      ...
      is_hidden: 0,
      is_active: 1,
      content: "{\"email\":\"hngwudev@gmail.com\",\"github\":\"https://github.com/HngWu\",\"linkedin\":\"https://www.linkedin.com/in/tan-hng-wu-8ab093262/\",\"telegram\":\"https://t.me/hngwu\"}",
  ...
  const seedTransaction = db.transaction(() => {
    ...
    const seedDetailed = [
      ...
      },
      {
        ...
        order_val: 1,
        created_at: "2026-08-15T04:15:26.774Z",
        updated_at: "2026-09-06 13:20:29"
      },
      {
      ...
      },
      {
        ...
        type: "experience",
        title: "Junior IT Application Support Engineer",
        subtitle: "To The Point Pte Ltd (TTP)",
        date_range: "Sep 2024 - Present",
        content: "{\"highlights\":[\"Executed end-to-end UAT and SIT testing cycles to validate software releases\",\"Investigated and debugged application issues and system anomalies across logs\",\"Authored comprehensive technical documentation, SOP runbooks, and test cases\",\"Coordinated deployment readiness and SLA defect tracking for client teams\"]}",
        deep_dive: "{\"highlights\":[\"Executed User Acceptance Testing (UAT) and System Integration Testing (SIT) for enterprise clients\",\"Identified edge-case regressions, debugged root causes in application logs, and logged structured defect reports\",\"Produced standardized operational runbooks, user manuals, and technical testing documentation\",\"Maintained incident response tracking and SLA adherence across production support workflows\"]}",
        order_val: 2,
        created_at: "2026-09-06 13:20:29",
        updated_at: "2026-09-06 13:20:29"
      },
      {
