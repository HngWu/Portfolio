...
INSERT INTO public.tiles (
  ...
  ('4c37c16b-3500-401f-88cb-bf839071a48c', 'hero', '6x4', NULL, NULL, 1, 1, false, true, '{"mark":"Work In progress","role":"Software Engineer","description":"Systems Architect. Specialized in high-performance web applications and immersive interfaces. Dark minimalist, cinematic UX."}'::jsonb, '{"mark":"Work In progress","role":"Software Engineer","description":"Creative Developer / Systems Architect. Specialized in high-performance web applications and immersive interfaces. Dark minimalist, cinematic UX."}'::jsonb, '2026-08-15T04:15:26.773Z', '2026-09-03T09:52:50.733Z'),
...
INSERT INTO public.detailed_items (
  ...
  ('00000000-0000-0000-0000-000000000001', 'experience', 'Software Engineer Intern', 'DBS Bank', 'Apr 2025 - Mar 2026', '{"highlights":["Led full-stack system migrations and automated pipeline deployments","Optimized data processing to speed up heavy application modules","Headed front-end overhauls and A/B testing to increase click-through rates","Managed database version control for seamless multi-environment deployments"]}'::jsonb, '{"highlights":["Migrated Martech Request Portal from MongoDB to MariaDB using Java Spring Boot APIs","Automated CI/CD deployment pipelines using Jenkins on OpenShift","Optimized high-data spreadsheet module performance using efficient data structures","Executed front-end A/B testing and tracking via Adobe Target and Adobe Analytics","Managed MariaDB schema changes and version control utilizing Liquibase scripts"]}'::jsonb, 1, '2026-08-15T04:15:26.774Z', '2026-09-06 13:20:29'),
  ...
  ('00000000-0000-0000-0000-000000000002', 'experience', 'Junior IT Application Support Engineer', 'To The Point Pte Ltd (TTP)', 'Sep 2024 - Present', '{"highlights":["Executed end-to-end UAT and SIT testing cycles to validate software releases","Investigated and debugged application issues and system anomalies across logs","Authored comprehensive technical documentation, SOP runbooks, and test cases","Coordinated deployment readiness and SLA defect tracking for client teams"]}'::jsonb, '{"highlights":["Executed User Acceptance Testing (UAT) and System Integration Testing (SIT) for enterprise clients","Identified edge-case regressions, debugged root causes in application logs, and logged structured defect reports","Produced standardized operational runbooks, user manuals, and technical testing documentation","Maintained incident response tracking and SLA adherence across production support workflows"]}'::jsonb, 2, '2026-09-06 13:20:29', '2026-09-06 13:20:29'),
